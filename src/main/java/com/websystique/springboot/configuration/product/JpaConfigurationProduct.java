package com.websystique.springboot.configuration.product;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.websystique.springboot.repositories.product",
        entityManagerFactoryRef = "productEntityManagerFactory",
        transactionManagerRef = "productTransactionManager")
@EnableTransactionManagement
public class JpaConfigurationProduct {
     ...
     */
    @Bean
    public LocalContainerEntityManagerFactoryBean productEntityManagerFactory() throws NamingException {
        LocalContainerEntityManagerFactoryBean factoryBean = new LocalContainerEntityManagerFactoryBean();
        factoryBean.setDataSource(productDataSource());
        factoryBean.setPackagesToScan(new String[]{"com.websystique.springboot.model.product"});
    ...
    public PlatformTransactionManager productTransactionManager() {
        ...
        try {
            txManager.setEntityManagerFactory(productEntityManagerFactory().getObject());
        } catch (NamingException e) {

            System.out.println("exception in JPACONFIGURATION in product");
            e.printStackTrace();
        }
        return txManager;
    }
